-- ====================================================================
-- CLEAR ROAD — 010: RPC create_report
--
-- The ONLY way browser clients create reports. Validates input server-side,
-- verifies an active anonymous session, computes expiry via the lifecycle
-- engine and returns a sanitised public JSON payload.
--
-- Lat/lng validation mirrors src/features/geo/coordinates.ts.
-- ====================================================================
...
-- Conceal internal error codes/surrounding work from API callers is handled
-- by PostgREST mapping; audiences keep the raw codes documented in
-- docs/DATA_MODEL.md for now.
